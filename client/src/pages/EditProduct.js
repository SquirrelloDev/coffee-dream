        ...
        return (
            <main className={classes.user}>
                ...
                <form onSubmit={this.validate.bind(this)} className={classes.user__form}>
                    <Input errStatus={this.state.errorObj.nameErr} errValue={'Enter a product name'} getValue={this.setName.bind(this)} label={'Product name'} defValue={this.state.name}/>
                    ...
                    <Input errStatus={this.state.errorObj.originErr} errValue={'Provide origin'} getValue={this.setOrigin.bind(this)} label={'Origin'} defValue={this.state.origin}/>
                    <Input errStatus={this.state.errorObj.compositionErr} errValue={'Provide composition'} getValue={this.setComposition.bind(this)} label={'Composition'} defValue={this.state.composition}/>
                    <Input errStatus={this.state.errorObj.aromaErr} errValue={'Provide aroma'} getValue={this.setAroma.bind(this)} label={'Aroma'} defValue={this.state.aroma}/>
